...
export default function KristysBearyFunFacts(){
	...
	return (<>
		...
		<div className="container h-[75vh] flex flex-col justify-center items-center  my-0 mx-auto  border-box">
			<div className="container w-4/5 relative scale-80 o">
				<Image src={"https://i.ibb.co/PtynfLD/kristys-beary-fun-facts-screenshot-fullsized.png"} width={1908} height={905} layout="intrinsic" alt=""/>
			</div>
