			...
			<div className="border border-4 border-midtone h-4/5 fixed overscroll-none flex justify-center items-center opacity-1 top-20 inset-y-16 inset-x-12 drop-shadow-md md:inset-x-16 lg:inset-x-32 xl:inset-x-60 lg:top-20 ">
				<div className="bg-bgDark w-full h-full">
					<div id="additionalProjectInfoModal-grid" className="h-full grid grid-rows-[10%_5%_1fr_2.5%_5%] grid-cols-[75%_25%]">
						...
						<div className="flex justify-center items-center bg-gradient-to-r from-midtone to-midtone/0 itemFont text-2xl font-bold lg:text-3xl">{name}</div>
						...
						<div id="project-info-section" className="overflow-y-scroll row-start-3 row-span-2 col-start-1 p-2 lg:p-7 contentFont">
						...
						<div id="things-i-learned-section" className="row-start-3 row-span-2 col-start-2 bg-gradient-to-b from-primary/25 to-primary/0 p-3 font-varela text-center">
							<h3 className="pb-5 font-semibold">Things I learned about:</h3>
							<ul>
