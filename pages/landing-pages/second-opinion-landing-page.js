	...
	return (<>
		<div className="container mx-auto bg-[#070709ff] mt-4">
		  	<div className="grid grid-rows-[175px_120px_1fr_1fr] o">
			      	...
			      	<form action="" className="w-1/2 text-xl pr-5">
			        	<div id="form-topSection" className="">
			          		<div className="py-2 grid grid-cols-[auto_192px] ">
			            		...
			            		<input id="url-input" className="so-font-main text-base text-[#8fbbff] text-center bg-slate-700 placeholder:text-[#62799c] rounded-full " type="url" name="url" placeholder="www.yourSite.com" />  
			          		</div>
				          	<div className="py-2 grid grid-cols-[auto_192px] ">
		  		...
		  		<div id="info-row "className="container b">

					      <div id="infoHeader-container">
					        <h1 id="infoHeader-text">Second Opinion</h1>
					      </div>

					      <p>
					        <center>At <span className="sizeup"><a href="#" className="highlight" id="homepage-link">Second Opinion</a></span>, we specialize in making <span className="highlight">YOUR</span> ideas work, focusing on those details that make the pieces fit.</center>
					      </p>
