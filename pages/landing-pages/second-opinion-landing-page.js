			...
			<div className="container flex justify-center items-center  my-0 mx-auto border-box lg:py-20 lg:bg-transparent  lg:mx-auto ">
		  	<div className="grid grid-rows-[225px_120px_1fr_1fr]  so-border lg:bg-[#070709ff] lg:grid-cols-[348px_400px_340px] lg:grid-rows-4  lg:h-[644px] ">
		  		...
		  		<div id="logo-row" className="grid grid-col-1 grid-rows-[99.9%_.1%] border-r-2 overflow-hidden lg:grid-rows-[.1%_99.9%] lg:row-span-4 " >
		  			...
		  			<Image src="/images/second-opinion-lunar.png" class="row-start-2 row-span-1 opacity-0 lg:row-start-1 lg:row-span-1 lg:object-contain lg:inline lg:opacity-100" width={348} height={644} alt="lunar curvature" />
		  		...
		  		<div id="form-row" className="container flex justify-center items-center lg:pt-0 lg:row-span-2 ">
			      	<form action="" className="w-1/2 text-xl pr-5 lg:w-full lg:pr-8 ">
			        	...
			        	<div id="form-buttonSection" className="flex justify-center pt-4 pl-4 lg:relative lg:-top-8">
				          <button className="bg-blue-400 py-4 px-6 rounded-full so-font-main font-bold">Let us have a look</button>
				        </div>
			      	</form>
			    </div>   
			     <div id="services-row" className="hidden flex-col items-center justify-center relative -top-16 h-[170px] so-font-main lg:flex lg:px-8  ">
				          ...
				          <div className="mt-4 mx-auto px-5 text-center font-bold">Use Coupon code: <span class="text-blue-400">2ndO</span> for 20% discount on order</div>
				        </div>	
