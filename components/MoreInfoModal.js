		...
		<div id="MoreInfoModal" className="animate-fadeIn">
			...
			<div className="border border-4 border-midtone h-4/5 fixed overscroll-none flex justify-center items-center opacity-1 top-20 inset-y-16 inset-x-12 drop-shadow-md md:inset-x-16 lg:inset-x-32 xl:inset-x-60 lg:top-20 ">
				<div className="bg-bgDark w-full h-full">
					<div id="additionalProjectInfoModal-grid" className="h-full grid grid-rows-[10%_5%_1fr_5%] grid-cols-[75%_25%]">
						...
						<div id="project-info-section" className="overflow-y-scroll row-start-3 row-span-2 col-start-1 p-2 lg:p-7">
							<div id="goal-section" className=" text-base text-accent/70 p-4 border-b-4 border-b-primary/25  lg:text-2xl"><span className="text-white text-3xl lg:text-4xl">Goal: </span>{short}</div>
						...
						<div id="bottom-spacer" className="row-start-4 row-span-1 col-start-1 col-span-2 bg-midtone"></div>	
